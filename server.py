...
if __name__=="__main__":
    ...
    if args['model_name'] == 'mnist_2nn':
        ...
        net = Cifar_CNN()
    elif args['model_name'] == 'cifar_costu':
        net = Cifar_customize()
    ...
    opti = optim.SGD(net.parameters(), lr=args['learning_rate'], momentum = args['momentum'])

    myClients = ClientsGroup(args['data'], args['IID'], args['num_of_clients'], dev)
    ...
    for i in range(args['num_comm']):
        ...
        with torch.no_grad():
            if (i + 1) % args['val_freq'] == 0:
                ...
                memo_dict.append((sum_accu / num).item())
                with open("./res/{}_{}_{}_{}_{}_{}_{}_{}_{}_acu.txt".format(args['data'], 
                                                                    args['num_comm'], 
                                                                    args['num_of_clients'], 
                                                                    args['cfraction'], 
                                                                    args['momentum'], 
                                                                    ...
                                                                    args['epoch'],
                                                                    args['IID']),  "w") as file:
                    file.write(json.dumps({'memo_dict':memo_dict}))
                    file.close()
